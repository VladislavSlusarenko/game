...
class Character(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.center = (SCREEN_WIDTH // 2, SCREEN_HEIGHT - CHARACTER_HEIGHT - 50)  # Задаем начальную позицию ниже
        self.velocity = 0.5
        self.jump = False
        self.jump_speed = 15
        self.last_idle_update = pygame.time.get_ticks()  # Отслеживание времени последнего обновления анимации в покое
        self.idle_image_index = 0  # Индекс текущего изображения анимации
    ...
    def update_animation(self):
        ...
        IDLE_ANIMATION_INTERVAL = 150  # 150 миллисекунд
        if current_time - self.last_idle_update > IDLE_ANIMATION_INTERVAL:
            ...
            self.image = self.idle_images[self.idle_image_index]  # Обновляем изображение анимации
...
# Создание платформы
platform = Platform(0, SCREEN_HEIGHT - 100, SCREEN_WIDTH, PLATFORM_HEIGHT)  # Установите платформу ниже
